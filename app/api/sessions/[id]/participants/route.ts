...
import { sessions, sessionParticipants, participants, expenseAssignments, sessionParticipantMeta } from '@/lib/db/schema';
...
export async function POST(request: NextRequest, { params }: RouteParams) {
  ...
  // Prevent late check-ins once the bill has been explicitly issued.
